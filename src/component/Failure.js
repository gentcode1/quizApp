  ...
  return (
    <div className="bg-primary h-screen flex flex-col">
          ...
          <div className="flex justify-between items-center ">
            <div>
              <div className="flex">
                ...
                <p>
                  Passed Questions:<span className="ml-2">1</span>
                </p>
              </div>
              ...
              <div className="flex">
                ...
                <p>
                  Failled Questions:<span className="ml-2">4</span>
                </p>
              </div>
      ...
      <div className='flex flex-row ml-52 mt-8'>
        ...
        <div className=" flex mr-8 mb-16 h-16 w-16 ring-2  ring-white rounded-full bg-white items-center justify-center "> Done</div>
      </div>
    </div>
  );
};
