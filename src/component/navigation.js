    ...
    <div class="flex w-full justify-evenly  text-xl">
      <div class="  flex-grow mr-16 lg:flex lg:items-center lg:w-auto hidden  lg:mt-0 bg-white lg:bg-transparent text-black  lg:p-0 z-20">
        <ul class='list-reset lg:flex justify-end flex-1 '>
          <li>
            <a class="inline-block text-blue-700 no-underline hover:text-gray-800 font-bold hover:underline py-2 px-4"> 
              Home
            </a>
          </li>
          <li>
            <a class="inline-block text-black no-underline hover:text-blue-700  font-bold hover:underline py-2 px-4" >
              About
            </a>
          </li>
          <li>
      ...
      <div class="flex lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black pr-12  lg:p-0 z-20">
        <button className='mr-16  bg-primary text-white w-24 h-10 rounded-lg hover:underline font-bold shadow opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out'>Login</button>
